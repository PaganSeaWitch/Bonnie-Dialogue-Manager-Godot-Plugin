...
func _ready() -> void:
	$NewTemplateButton.text = Syntax.translate("settings.new_template")
	$MissingTranslationsButton.text = Syntax.translate("settings.missing_keys")
	$MissingTranslationsHint.text = Syntax.translate("settings.missing_keys_hint")
	$WrapLinesButton.text = Syntax.translate("settings.wrap_long_lines")
	$IncludeAllResponsesButton.text = Syntax.translate("settings.include_failed_responses")
	$CustomTestSceneLabel.text = Syntax.translate("settings.custom_test_scene")
	$StatesTitle.text = Syntax.translate("settings.states_shortcuts")
	$StatesMessage.text = Syntax.translate("settings.states_message")
	$StatesHint.text = Syntax.translate("settings.states_hint")
...
func prepare() -> void:
	...
	revert_test_scene_button.tooltip_text = Syntax.translate("settings.revert_to_default_test_scene")
	...
	globals_list.set_column_title(0, Syntax.translate("settings.autoload"))
	globals_list.set_column_title(1, "")
	globals_list.set_column_title(2, Syntax.translate("settings.path"))
